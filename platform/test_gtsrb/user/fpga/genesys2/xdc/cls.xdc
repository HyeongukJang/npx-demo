...
set_property -dict { PACKAGE_PIN T22   IOSTANDARD LVCMOS33 } [get_ports { cls_uart_tx }]; #IO_L5P_T0_D06_14 Sch=ja_p[3] # pin 7
set_property -dict { PACKAGE_PIN T23   IOSTANDARD LVCMOS33 } [get_ports { cls_uart_rx }]; #IO_L5N_T0_D07_14 Sch=ja_n[3] # pin 8
